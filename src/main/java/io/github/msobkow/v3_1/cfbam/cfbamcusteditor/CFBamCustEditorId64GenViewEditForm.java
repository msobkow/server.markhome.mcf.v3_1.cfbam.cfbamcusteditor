 ...
 *	for Id64Gen.
 */
public class CFBamCustEditorId64GenViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorId64GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsId64Gen().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsId64Gen().getOptionalLookupDefSchema() != null ) ) {
