 ...
 *	for ServerProc.
 */
public class CFBamCustEditorServerProcAttrPane
extends CFGridPane
implements ICFBamJavaFXServerProcPaneCommon
{
	...
	public CFBamCustEditorServerProcAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
