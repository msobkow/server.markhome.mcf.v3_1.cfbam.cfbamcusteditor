 ...
 *	for TextType.
 */
public class CFBamCustEditorTextTypeFactory
extends CFBamJavaFXTextTypeFactory
{
	public CFBamCustEditorTextTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTextTypeObj argFocus ) {
		CFBamCustEditorTextTypeAttrPane retnew = new CFBamCustEditorTextTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTextTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTextTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTextTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTextTypeViewEditForm retnew = new CFBamCustEditorTextTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
