 ...
 *	for BoolCol.
 */
public class CFBamCustEditorBoolColFactory
extends CFBamJavaFXBoolColFactory
{
	public CFBamCustEditorBoolColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamBoolColObj argFocus ) {
		CFBamCustEditorBoolColAttrPane retnew = new CFBamCustEditorBoolColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamBoolColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamBoolColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamBoolColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorBoolColViewEditForm retnew = new CFBamCustEditorBoolColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
