 ...
 *	for Int64Type.
 */
public class CFBamCustEditorInt64TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt64TypePaneCommon
{
	...
	public CFBamCustEditorInt64TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
