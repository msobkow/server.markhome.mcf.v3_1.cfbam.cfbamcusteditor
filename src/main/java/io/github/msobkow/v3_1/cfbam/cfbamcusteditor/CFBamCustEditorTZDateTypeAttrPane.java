 ...
 *	for TZDateType.
 */
public class CFBamCustEditorTZDateTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTZDateTypePaneCommon
{
	...
	public CFBamCustEditorTZDateTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
