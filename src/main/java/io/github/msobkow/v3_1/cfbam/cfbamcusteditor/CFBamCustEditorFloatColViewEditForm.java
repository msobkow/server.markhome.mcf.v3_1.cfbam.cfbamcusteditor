 ...
 *	for FloatCol.
 */
public class CFBamCustEditorFloatColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorFloatColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsFloatCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsFloatCol().getOptionalLookupDefSchema() != null ) ) {
