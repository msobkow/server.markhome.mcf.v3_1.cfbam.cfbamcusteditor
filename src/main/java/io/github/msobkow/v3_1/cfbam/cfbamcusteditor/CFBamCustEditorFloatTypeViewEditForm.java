 ...
 *	for FloatType.
 */
public class CFBamCustEditorFloatTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorFloatTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsFloatType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsFloatType().getOptionalLookupDefSchema() != null ) ) {
