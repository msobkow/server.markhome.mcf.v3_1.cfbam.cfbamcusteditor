 ...
 *	for TZTimeCol.
 */
public class CFBamCustEditorTZTimeColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZTimeColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZTimeCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZTimeCol().getOptionalLookupDefSchema() != null ) ) {
