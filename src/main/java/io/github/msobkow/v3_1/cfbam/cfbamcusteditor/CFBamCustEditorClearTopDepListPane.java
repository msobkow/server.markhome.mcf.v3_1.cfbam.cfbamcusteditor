 ...
 *	for ClearTopDep.
 */
public class CFBamCustEditorClearTopDepListPane
...
implements ICFBamJavaFXClearTopDepPaneList
{
	...
	public CFBamCustEditorClearTopDepListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		...
		tableColumnLookupDefSchema = new TableColumn<ICFBamClearTopDepObj, ICFBamSchemaDefObj>( "Defining Schema" );
