 ...
 *	for DoubleType.
 */
public class CFBamCustEditorDoubleTypeFactory
extends CFBamJavaFXDoubleTypeFactory
{
	public CFBamCustEditorDoubleTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamDoubleTypeObj argFocus ) {
		CFBamCustEditorDoubleTypeAttrPane retnew = new CFBamCustEditorDoubleTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamDoubleTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamDoubleTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamDoubleTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorDoubleTypeViewEditForm retnew = new CFBamCustEditorDoubleTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
