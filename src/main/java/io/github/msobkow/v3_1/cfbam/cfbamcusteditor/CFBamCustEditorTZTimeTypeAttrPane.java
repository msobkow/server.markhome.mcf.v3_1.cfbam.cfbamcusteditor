 ...
 *	for TZTimeType.
 */
public class CFBamCustEditorTZTimeTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTZTimeTypePaneCommon
{
	...
	public CFBamCustEditorTZTimeTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
