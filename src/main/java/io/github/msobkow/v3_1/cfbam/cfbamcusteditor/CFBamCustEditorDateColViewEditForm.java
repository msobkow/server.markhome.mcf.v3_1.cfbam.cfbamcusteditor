 ...
 *	for DateCol.
 */
public class CFBamCustEditorDateColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorDateColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsDateCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsDateCol().getOptionalLookupDefSchema() != null ) ) {
