 ...
 *	for BlobCol.
 */
public class CFBamCustEditorBlobColAttrPane
extends CFGridPane
implements ICFBamJavaFXBlobColPaneCommon
{
	...
	public CFBamCustEditorBlobColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
