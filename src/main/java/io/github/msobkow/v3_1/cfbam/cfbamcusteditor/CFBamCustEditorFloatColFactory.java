 ...
 *	for FloatCol.
 */
public class CFBamCustEditorFloatColFactory
extends CFBamJavaFXFloatColFactory
{
	public CFBamCustEditorFloatColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamFloatColObj argFocus ) {
		CFBamCustEditorFloatColAttrPane retnew = new CFBamCustEditorFloatColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamFloatColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamFloatColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamFloatColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorFloatColViewEditForm retnew = new CFBamCustEditorFloatColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
