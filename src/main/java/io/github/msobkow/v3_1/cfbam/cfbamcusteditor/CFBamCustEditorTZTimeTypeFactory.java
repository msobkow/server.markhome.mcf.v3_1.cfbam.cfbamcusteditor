 ...
 *	for TZTimeType.
 */
public class CFBamCustEditorTZTimeTypeFactory
extends CFBamJavaFXTZTimeTypeFactory
{
	public CFBamCustEditorTZTimeTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTZTimeTypeObj argFocus ) {
		CFBamCustEditorTZTimeTypeAttrPane retnew = new CFBamCustEditorTZTimeTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTZTimeTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTZTimeTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTZTimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTZTimeTypeViewEditForm retnew = new CFBamCustEditorTZTimeTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
