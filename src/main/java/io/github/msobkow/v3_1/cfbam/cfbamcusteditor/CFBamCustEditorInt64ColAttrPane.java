 ...
 *	for Int64Col.
 */
public class CFBamCustEditorInt64ColAttrPane
extends CFGridPane
implements ICFBamJavaFXInt64ColPaneCommon
{
	...
	public CFBamCustEditorInt64ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
