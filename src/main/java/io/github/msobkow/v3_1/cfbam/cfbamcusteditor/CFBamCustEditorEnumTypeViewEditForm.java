 ...
 *	for EnumType.
 */
public class CFBamCustEditorEnumTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorEnumTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsEnumType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsEnumType().getOptionalLookupDefSchema() != null ) ) {
