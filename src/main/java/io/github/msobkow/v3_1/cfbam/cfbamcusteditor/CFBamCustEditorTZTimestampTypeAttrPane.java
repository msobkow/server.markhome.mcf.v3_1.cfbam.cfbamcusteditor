 ...
 *	for TZTimestampType.
 */
public class CFBamCustEditorTZTimestampTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTZTimestampTypePaneCommon
{
	...
	public CFBamCustEditorTZTimestampTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
