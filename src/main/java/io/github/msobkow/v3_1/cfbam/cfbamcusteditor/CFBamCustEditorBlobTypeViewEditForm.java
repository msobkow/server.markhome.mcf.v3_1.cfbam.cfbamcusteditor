 ...
 *	for BlobType.
 */
public class CFBamCustEditorBlobTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorBlobTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsBlobType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsBlobType().getOptionalLookupDefSchema() != null ) ) {
