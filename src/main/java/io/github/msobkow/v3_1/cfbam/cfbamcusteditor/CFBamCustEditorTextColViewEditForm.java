 ...
 *	for TextCol.
 */
public class CFBamCustEditorTextColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTextColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTextCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTextCol().getOptionalLookupDefSchema() != null ) ) {
