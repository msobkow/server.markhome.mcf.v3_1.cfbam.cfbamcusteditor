 ...
 *	for DateType.
 */
public class CFBamCustEditorDateTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorDateTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsDateType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsDateType().getOptionalLookupDefSchema() != null ) ) {
