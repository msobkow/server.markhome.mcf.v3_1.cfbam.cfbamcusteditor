 ...
 *	for ServerListFunc.
 */
public class CFBamCustEditorServerListFuncAttrPane
extends CFGridPane
implements ICFBamJavaFXServerListFuncPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			List<ICFBamTableObj> listOfTable = focus.getRequiredContainerForTable().getRequiredContainerSchemaDef().getOptionalComponentsTables();
	...
	public CFBamCustEditorServerListFuncAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		if( editObj.getOptionalLookupRetTable() == null ) {
			throw new CFLibEmptyArgumentException( getClass(),
				S_ProcName,
				0,
				"ReturnTable" );
