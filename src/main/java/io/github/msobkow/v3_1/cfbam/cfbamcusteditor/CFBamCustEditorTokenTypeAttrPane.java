 ...
 *	for TokenType.
 */
public class CFBamCustEditorTokenTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTokenTypePaneCommon
{
	...
	public CFBamCustEditorTokenTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		String initValue = getJavaFXEditorInitValue().getTokenValue();
