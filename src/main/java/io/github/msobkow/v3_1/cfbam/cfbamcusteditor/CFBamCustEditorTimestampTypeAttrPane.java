 ...
 *	for TimestampType.
 */
public class CFBamCustEditorTimestampTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTimestampTypePaneCommon
{
	...
	public CFBamCustEditorTimestampTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
