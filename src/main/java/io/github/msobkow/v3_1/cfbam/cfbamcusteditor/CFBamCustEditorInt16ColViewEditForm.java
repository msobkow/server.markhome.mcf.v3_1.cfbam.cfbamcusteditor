 ...
 *	for Int16Col.
 */
public class CFBamCustEditorInt16ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt16ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt16Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt16Col().getOptionalLookupDefSchema() != null ) ) {
