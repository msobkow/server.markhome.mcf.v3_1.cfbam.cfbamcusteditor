 ...
 *	for TimeType.
 */
public class CFBamCustEditorTimeTypeFactory
extends CFBamJavaFXTimeTypeFactory
{
	public CFBamCustEditorTimeTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTimeTypeObj argFocus ) {
		CFBamCustEditorTimeTypeAttrPane retnew = new CFBamCustEditorTimeTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTimeTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTimeTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTimeTypeViewEditForm retnew = new CFBamCustEditorTimeTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
