 ...
 *	for NumberCol.
 */
public class CFBamCustEditorNumberColAttrPane
extends CFGridPane
implements ICFBamJavaFXNumberColPaneCommon
{
	...
	public CFBamCustEditorNumberColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
