 ...
 *	for Int32Col.
 */
public class CFBamCustEditorInt32ColAttrPane
extends CFGridPane
implements ICFBamJavaFXInt32ColPaneCommon
{
	...
	public CFBamCustEditorInt32ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
