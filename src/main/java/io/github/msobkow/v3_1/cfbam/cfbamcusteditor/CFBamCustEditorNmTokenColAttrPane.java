 ...
 *	for NmTokenCol.
 */
public class CFBamCustEditorNmTokenColAttrPane
extends CFGridPane
implements ICFBamJavaFXNmTokenColPaneCommon
{
	...
	public CFBamCustEditorNmTokenColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
