 ...
 *	for UInt64Type.
 */
public class CFBamCustEditorUInt64TypeFactory
extends CFBamJavaFXUInt64TypeFactory
{
	public CFBamCustEditorUInt64TypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamUInt64TypeObj argFocus ) {
		CFBamCustEditorUInt64TypeAttrPane retnew = new CFBamCustEditorUInt64TypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamUInt64TypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamUInt64TypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamUInt64TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorUInt64TypeViewEditForm retnew = new CFBamCustEditorUInt64TypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
