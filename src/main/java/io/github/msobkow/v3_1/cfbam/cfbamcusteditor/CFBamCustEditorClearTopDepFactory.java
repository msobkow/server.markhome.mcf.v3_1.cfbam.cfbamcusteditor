 ...
 *	for ClearTopDep.
 */
public class CFBamCustEditorClearTopDepFactory
extends CFBamJavaFXClearTopDepFactory
{
	public CFBamCustEditorClearTopDepFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamClearTopDepObj argFocus ) {
		CFBamCustEditorClearTopDepAttrPane retnew = new CFBamCustEditorClearTopDepAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorClearTopDepListPane retnew = new CFBamCustEditorClearTopDepListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
	...
	public CFSplitPane newViewEditPane( ICFFormManager formManager, ICFBamClearTopDepObj argFocus ) {
		CFBamCustEditorClearTopDepViewEditPane retnew = new CFBamCustEditorClearTopDepViewEditPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamClearTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorClearTopDepViewEditForm retnew = new CFBamCustEditorClearTopDepViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
