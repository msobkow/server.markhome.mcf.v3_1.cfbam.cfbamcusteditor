 ...
 *	for TokenCol.
 */
public class CFBamCustEditorTokenColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTokenColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTokenCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTokenCol().getOptionalLookupDefSchema() != null ) ) {
