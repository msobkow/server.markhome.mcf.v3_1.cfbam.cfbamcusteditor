 ...
 *	for UInt32Col.
 */
public class CFBamCustEditorUInt32ColAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt32ColPaneCommon
{
	...
	public CFBamCustEditorUInt32ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
