 ...
 *	for TokenCol.
 */
public class CFBamCustEditorTokenColAttrPane
extends CFGridPane
implements ICFBamJavaFXTokenColPaneCommon
{
	...
	public CFBamCustEditorTokenColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
