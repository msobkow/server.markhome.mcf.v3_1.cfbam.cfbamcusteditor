 ...
 *	for TableCol.
 */
public class CFBamCustEditorTableColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTableColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTableCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTableCol().getOptionalLookupDefSchema() != null ) ) {
