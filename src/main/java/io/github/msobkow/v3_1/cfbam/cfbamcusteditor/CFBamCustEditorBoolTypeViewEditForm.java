 ...
 *	for BoolType.
 */
public class CFBamCustEditorBoolTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorBoolTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsBoolType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsBoolType().getOptionalLookupDefSchema() != null ) ) {
