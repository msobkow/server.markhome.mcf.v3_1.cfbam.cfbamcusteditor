 ...
 *	for EnumTag.
 */
public class CFBamCustEditorEnumTagViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorEnumTagViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsEnumTag().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsEnumTag().getOptionalLookupDefSchema() != null ) ) {
