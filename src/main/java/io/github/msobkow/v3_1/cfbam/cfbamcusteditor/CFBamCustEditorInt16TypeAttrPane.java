 ...
 *	for Int16Type.
 */
public class CFBamCustEditorInt16TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt16TypePaneCommon
{
	...
	public CFBamCustEditorInt16TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
