 ...
 *	for NmTokenType.
 */
public class CFBamCustEditorNmTokenTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXNmTokenTypePaneCommon
{
	...
	public CFBamCustEditorNmTokenTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		String initValue = getJavaFXEditorInitValue().getNmTokenValue();
