 ...
 *	for StringType.
 */
public class CFBamCustEditorStringTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorStringTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsStringType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsStringType().getOptionalLookupDefSchema() != null ) ) {
