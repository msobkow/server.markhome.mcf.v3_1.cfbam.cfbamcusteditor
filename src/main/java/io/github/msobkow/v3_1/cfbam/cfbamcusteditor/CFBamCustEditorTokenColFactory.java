 ...
 *	for TokenCol.
 */
public class CFBamCustEditorTokenColFactory
extends CFBamJavaFXTokenColFactory
{
	public CFBamCustEditorTokenColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTokenColObj argFocus ) {
		CFBamCustEditorTokenColAttrPane retnew = new CFBamCustEditorTokenColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTokenColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamTokenColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTokenColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTokenColViewEditForm retnew = new CFBamCustEditorTokenColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
