 ...
 *	for BlobCol.
 */
public class CFBamCustEditorBlobColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorBlobColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsBlobCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( buttonEdit != null ) {
				if( ( javaFXFocus == null ) || ( getJavaFXFocusAsBlobCol().getOptionalLookupDefSchema() != null ) ) {
