 ...
 *	for NmTokenType.
 */
public class CFBamCustEditorNmTokenTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNmTokenTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNmTokenType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNmTokenType().getOptionalLookupDefSchema() != null ) ) {
