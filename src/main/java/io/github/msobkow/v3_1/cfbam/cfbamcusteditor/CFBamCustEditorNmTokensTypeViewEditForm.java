 ...
 *	for NmTokensType.
 */
public class CFBamCustEditorNmTokensTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNmTokensTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNmTokensType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNmTokensType().getOptionalLookupDefSchema() != null ) ) {
