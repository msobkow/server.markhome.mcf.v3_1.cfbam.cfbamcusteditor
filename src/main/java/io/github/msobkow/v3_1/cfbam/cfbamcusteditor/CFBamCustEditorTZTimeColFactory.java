 ...
 *	for TZTimeCol.
 */
public class CFBamCustEditorTZTimeColFactory
extends CFBamJavaFXTZTimeColFactory
{
	public CFBamCustEditorTZTimeColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTZTimeColObj argFocus ) {
		CFBamCustEditorTZTimeColAttrPane retnew = new CFBamCustEditorTZTimeColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTZTimeColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamTZTimeColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTZTimeColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTZTimeColViewEditForm retnew = new CFBamCustEditorTZTimeColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
