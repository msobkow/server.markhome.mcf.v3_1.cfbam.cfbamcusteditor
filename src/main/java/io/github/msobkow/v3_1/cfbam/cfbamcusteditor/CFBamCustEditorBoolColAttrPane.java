 ...
 *	for BoolCol.
 */
public class CFBamCustEditorBoolColAttrPane
extends CFGridPane
implements ICFBamJavaFXBoolColPaneCommon
{
	...
	public CFBamCustEditorBoolColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
