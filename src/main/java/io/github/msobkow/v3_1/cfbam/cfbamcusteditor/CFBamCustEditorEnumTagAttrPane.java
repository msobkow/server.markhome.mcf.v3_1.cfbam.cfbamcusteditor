 ...
 *	for EnumTag.
 */
public class CFBamCustEditorEnumTagAttrPane
extends CFGridPane
implements ICFBamJavaFXEnumTagPaneCommon
{
	...
	public CFBamCustEditorEnumTagAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
