 ...
 *	for DelTopDep.
 */
public class CFBamCustEditorDelTopDepViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorDelTopDepViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsDelTopDep().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsDelTopDep().getOptionalLookupDefSchema() != null ) ) {
