 ...
 *	for UuidCol.
 */
public class CFBamCustEditorUuidColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUuidColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUuidCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUuidCol().getOptionalLookupDefSchema() != null ) ) {
