 ...
 *	for StringCol.
 */
public class CFBamCustEditorStringColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorStringColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsStringCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsStringCol().getOptionalLookupDefSchema() != null ) ) {
