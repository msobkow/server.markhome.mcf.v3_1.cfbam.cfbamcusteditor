 ...
 *	for Param.
 */
public class CFBamCustEditorParamFactory
extends CFBamJavaFXParamFactory
{
	public CFBamCustEditorParamFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamParamObj argFocus ) {
		CFBamCustEditorParamAttrPane retnew = new CFBamCustEditorParamAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorParamListPane retnew = new CFBamCustEditorParamListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamParamObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorParamViewEditForm retnew = new CFBamCustEditorParamViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
