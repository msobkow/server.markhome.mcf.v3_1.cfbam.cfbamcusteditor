 ...
 *	for DoubleCol.
 */
public class CFBamCustEditorDoubleColAttrPane
extends CFGridPane
implements ICFBamJavaFXDoubleColPaneCommon
{
	...
	public CFBamCustEditorDoubleColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
