 ...
 *	for StringType.
 */
public class CFBamCustEditorStringTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXStringTypePaneCommon
{
	...
	public CFBamCustEditorStringTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		String initValue = getJavaFXEditorInitValue().getStringValue();
