 ...
 *	for Int32Col.
 */
public class CFBamCustEditorInt32ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt32ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt32Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt32Col().getOptionalLookupDefSchema() != null ) ) {
