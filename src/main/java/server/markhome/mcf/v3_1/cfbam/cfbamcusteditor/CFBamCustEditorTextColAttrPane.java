 ...
 *	for TextCol.
 */
public class CFBamCustEditorTextColAttrPane
extends CFGridPane
implements ICFBamJavaFXTextColPaneCommon
{
	...
	public CFBamCustEditorTextColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
