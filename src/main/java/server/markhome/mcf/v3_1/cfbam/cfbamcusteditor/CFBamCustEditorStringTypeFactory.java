 ...
 *	for StringType.
 */
public class CFBamCustEditorStringTypeFactory
extends CFBamJavaFXStringTypeFactory
{
	public CFBamCustEditorStringTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamStringTypeObj argFocus ) {
		CFBamCustEditorStringTypeAttrPane retnew = new CFBamCustEditorStringTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamStringTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamStringTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamStringTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorStringTypeViewEditForm retnew = new CFBamCustEditorStringTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
