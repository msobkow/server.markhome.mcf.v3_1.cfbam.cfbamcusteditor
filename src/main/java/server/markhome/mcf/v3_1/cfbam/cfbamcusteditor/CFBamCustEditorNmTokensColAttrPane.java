 ...
 *	for NmTokensCol.
 */
public class CFBamCustEditorNmTokensColAttrPane
extends CFGridPane
implements ICFBamJavaFXNmTokensColPaneCommon
{
	...
	public CFBamCustEditorNmTokensColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
