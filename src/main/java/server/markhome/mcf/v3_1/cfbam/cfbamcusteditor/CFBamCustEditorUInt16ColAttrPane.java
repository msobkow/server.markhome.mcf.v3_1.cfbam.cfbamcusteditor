 ...
 *	for UInt16Col.
 */
public class CFBamCustEditorUInt16ColAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt16ColPaneCommon
{
	...
	public CFBamCustEditorUInt16ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
