 ...
 *	for Int64Type.
 */
public class CFBamCustEditorInt64TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt64TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt64Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt64Type().getOptionalLookupDefSchema() != null ) ) {
