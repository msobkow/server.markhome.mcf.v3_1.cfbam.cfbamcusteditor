 ...
 *	for Int16Type.
 */
public class CFBamCustEditorInt16TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt16TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt16Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt16Type().getOptionalLookupDefSchema() != null ) ) {
