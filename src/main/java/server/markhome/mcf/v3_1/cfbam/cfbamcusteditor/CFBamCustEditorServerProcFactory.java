 ...
 *	for ServerProc.
 */
public class CFBamCustEditorServerProcFactory
extends CFBamJavaFXServerProcFactory
{
	public CFBamCustEditorServerProcFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamServerProcObj argFocus ) {
		CFBamCustEditorServerProcAttrPane retnew = new CFBamCustEditorServerProcAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamServerProcObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamServerProcObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamServerProcObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorServerProcViewEditForm retnew = new CFBamCustEditorServerProcViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
