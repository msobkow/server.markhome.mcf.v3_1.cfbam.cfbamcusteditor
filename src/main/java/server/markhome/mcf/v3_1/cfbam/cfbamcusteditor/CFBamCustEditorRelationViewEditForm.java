 ...
 *	for Relation.
 */
public class CFBamCustEditorRelationViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorRelationViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsRelation().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsRelation().getOptionalLookupDefSchema() != null ) ) {
