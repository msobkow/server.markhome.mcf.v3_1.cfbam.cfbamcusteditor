 ...
 *	for Id32Gen.
 */
public class CFBamCustEditorId32GenViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorId32GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId32GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsId32Gen().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsId32Gen().getOptionalLookupDefSchema() != null ) ) {
