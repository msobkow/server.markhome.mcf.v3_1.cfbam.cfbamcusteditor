 ...
 *	for Int32Type.
 */
public class CFBamCustEditorInt32TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt32TypePaneCommon
{
	...
	public CFBamCustEditorInt32TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
