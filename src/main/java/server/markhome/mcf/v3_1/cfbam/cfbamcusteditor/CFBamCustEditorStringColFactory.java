 ...
 *	for StringCol.
 */
public class CFBamCustEditorStringColFactory
extends CFBamJavaFXStringColFactory
{
	public CFBamCustEditorStringColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamStringColObj argFocus ) {
		CFBamCustEditorStringColAttrPane retnew = new CFBamCustEditorStringColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamStringColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamStringColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamStringColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorStringColViewEditForm retnew = new CFBamCustEditorStringColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
