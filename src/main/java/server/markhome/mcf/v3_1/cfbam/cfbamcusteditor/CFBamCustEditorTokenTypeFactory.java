 ...
 *	for TokenType.
 */
public class CFBamCustEditorTokenTypeFactory
extends CFBamJavaFXTokenTypeFactory
{
	public CFBamCustEditorTokenTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTokenTypeObj argFocus ) {
		CFBamCustEditorTokenTypeAttrPane retnew = new CFBamCustEditorTokenTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTokenTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTokenTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTokenTypeViewEditForm retnew = new CFBamCustEditorTokenTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
