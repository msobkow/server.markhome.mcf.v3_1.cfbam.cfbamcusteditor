 ...
 *	for NmTokenCol.
 */
public class CFBamCustEditorNmTokenColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNmTokenColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNmTokenCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNmTokenCol().getOptionalLookupDefSchema() != null ) ) {
