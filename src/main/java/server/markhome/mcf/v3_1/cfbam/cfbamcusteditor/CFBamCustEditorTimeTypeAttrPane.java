 ...
 *	for TimeType.
 */
public class CFBamCustEditorTimeTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTimeTypePaneCommon
{
	...
	public CFBamCustEditorTimeTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
