 ...
 *	for BlobType.
 */
public class CFBamCustEditorBlobTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXBlobTypePaneCommon
{
	...
	public CFBamCustEditorBlobTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
