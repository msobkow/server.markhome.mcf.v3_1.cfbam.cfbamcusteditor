 ...
 *	for TokenType.
 */
public class CFBamCustEditorTokenTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTokenTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTokenType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTokenType().getOptionalLookupDefSchema() != null ) ) {
