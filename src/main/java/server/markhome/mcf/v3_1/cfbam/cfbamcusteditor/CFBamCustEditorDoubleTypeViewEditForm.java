 ...
 *	for DoubleType.
 */
public class CFBamCustEditorDoubleTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorDoubleTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsDoubleType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsDoubleType().getOptionalLookupDefSchema() != null ) ) {
