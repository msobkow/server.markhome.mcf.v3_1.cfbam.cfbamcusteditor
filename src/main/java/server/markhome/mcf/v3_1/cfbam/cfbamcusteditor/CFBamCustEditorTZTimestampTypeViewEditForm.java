 ...
 *	for TZTimestampType.
 */
public class CFBamCustEditorTZTimestampTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZTimestampTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZTimestampType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZTimestampType().getOptionalLookupDefSchema() != null ) ) {
