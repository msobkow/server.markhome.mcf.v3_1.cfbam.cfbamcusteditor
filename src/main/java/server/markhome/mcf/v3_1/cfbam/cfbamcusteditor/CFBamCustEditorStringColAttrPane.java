 ...
 *	for StringCol.
 */
public class CFBamCustEditorStringColAttrPane
extends CFGridPane
implements ICFBamJavaFXStringColPaneCommon
{
	...
	public CFBamCustEditorStringColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
