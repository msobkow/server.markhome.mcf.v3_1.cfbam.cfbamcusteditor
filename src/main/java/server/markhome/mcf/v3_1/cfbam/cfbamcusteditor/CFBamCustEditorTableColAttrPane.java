 ...
 *	for TableCol.
 */
public class CFBamCustEditorTableColAttrPane
extends CFGridPane
implements ICFBamJavaFXTableColPaneCommon
{
	...
	public CFBamCustEditorTableColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
