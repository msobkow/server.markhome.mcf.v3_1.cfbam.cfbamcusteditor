 ...
 *	for DelTopDep.
 */
public class CFBamCustEditorDelTopDepFactory
extends CFBamJavaFXDelTopDepFactory
{
	public CFBamCustEditorDelTopDepFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamDelTopDepObj argFocus ) {
		CFBamCustEditorDelTopDepAttrPane retnew = new CFBamCustEditorDelTopDepAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorDelTopDepListPane retnew = new CFBamCustEditorDelTopDepListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
	...
	public CFSplitPane newViewEditPane( ICFFormManager formManager, ICFBamDelTopDepObj argFocus ) {
		CFBamCustEditorDelTopDepViewEditPane retnew = new CFBamCustEditorDelTopDepViewEditPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamDelTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorDelTopDepViewEditForm retnew = new CFBamCustEditorDelTopDepViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
