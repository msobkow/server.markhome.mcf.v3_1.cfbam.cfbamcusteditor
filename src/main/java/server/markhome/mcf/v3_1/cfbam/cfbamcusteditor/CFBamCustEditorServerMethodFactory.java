 ...
 *	for ServerMethod.
 */
public class CFBamCustEditorServerMethodFactory
extends CFBamJavaFXServerMethodFactory
{
	public CFBamCustEditorServerMethodFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorServerMethodListPane retnew = new CFBamCustEditorServerMethodListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
