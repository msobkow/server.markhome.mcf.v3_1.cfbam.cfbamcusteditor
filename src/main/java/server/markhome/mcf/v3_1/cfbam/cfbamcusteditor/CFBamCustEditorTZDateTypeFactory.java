 ...
 *	for TZDateType.
 */
public class CFBamCustEditorTZDateTypeFactory
extends CFBamJavaFXTZDateTypeFactory
{
	public CFBamCustEditorTZDateTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTZDateTypeObj argFocus ) {
		CFBamCustEditorTZDateTypeAttrPane retnew = new CFBamCustEditorTZDateTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTZDateTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTZDateTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTZDateTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTZDateTypeViewEditForm retnew = new CFBamCustEditorTZDateTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
