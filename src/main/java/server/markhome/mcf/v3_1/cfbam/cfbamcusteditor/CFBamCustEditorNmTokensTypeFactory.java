 ...
 *	for NmTokensType.
 */
public class CFBamCustEditorNmTokensTypeFactory
extends CFBamJavaFXNmTokensTypeFactory
{
	public CFBamCustEditorNmTokensTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamNmTokensTypeObj argFocus ) {
		CFBamCustEditorNmTokensTypeAttrPane retnew = new CFBamCustEditorNmTokensTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamNmTokensTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamNmTokensTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamNmTokensTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorNmTokensTypeViewEditForm retnew = new CFBamCustEditorNmTokensTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
