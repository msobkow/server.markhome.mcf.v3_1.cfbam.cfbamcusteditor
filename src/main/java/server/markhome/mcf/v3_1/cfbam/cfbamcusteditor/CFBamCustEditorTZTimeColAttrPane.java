 ...
 *	for TZTimeCol.
 */
public class CFBamCustEditorTZTimeColAttrPane
extends CFGridPane
implements ICFBamJavaFXTZTimeColPaneCommon
{
	...
	public CFBamCustEditorTZTimeColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
