 ...
 *	for Int16Col.
 */
public class CFBamCustEditorInt16ColAttrPane
extends CFGridPane
implements ICFBamJavaFXInt16ColPaneCommon
{
	...
	public CFBamCustEditorInt16ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
