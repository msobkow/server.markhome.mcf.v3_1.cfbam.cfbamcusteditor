 ...
 *	for TZDateCol.
 */
public class CFBamCustEditorTZDateColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZDateColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZDateCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZDateCol().getOptionalLookupDefSchema() != null ) ) {
