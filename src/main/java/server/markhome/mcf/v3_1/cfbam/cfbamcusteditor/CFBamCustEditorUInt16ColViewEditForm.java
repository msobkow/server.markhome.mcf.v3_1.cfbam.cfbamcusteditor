 ...
 *	for UInt16Col.
 */
public class CFBamCustEditorUInt16ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt16ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt16Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt16Col().getOptionalLookupDefSchema() != null ) ) {
