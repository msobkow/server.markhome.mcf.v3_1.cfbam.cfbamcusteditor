 ...
 *	for DoubleCol.
 */
public class CFBamCustEditorDoubleColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorDoubleColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsDoubleCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsDoubleCol().getOptionalLookupDefSchema() != null ) ) {
