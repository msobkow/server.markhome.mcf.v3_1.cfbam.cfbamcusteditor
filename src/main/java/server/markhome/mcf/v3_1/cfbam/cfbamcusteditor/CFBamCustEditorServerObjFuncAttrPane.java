 ...
 *	for ServerObjFunc.
 */
public class CFBamCustEditorServerObjFuncAttrPane
extends CFGridPane
implements ICFBamJavaFXServerObjFuncPaneCommon
{
	...
	public CFBamCustEditorServerObjFuncAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerObjFuncObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
