 ...
 *	for NmTokensType.
 */
public class CFBamCustEditorNmTokensTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXNmTokensTypePaneCommon
{
	...
	public CFBamCustEditorNmTokensTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		String initValue = getJavaFXEditorInitValue().getNmTokensValue();
		if( ( ! editObj.getRequiredIsNullable() ) && ( initValue == null ) ) {
			initValue = "";
		}
		editObj.setOptionalInitValue( initValue );
