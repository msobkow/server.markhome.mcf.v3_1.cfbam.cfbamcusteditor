 ...
 *	for UInt64Type.
 */
public class CFBamCustEditorUInt64TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt64TypePaneCommon
{
	...
	public CFBamCustEditorUInt64TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
