 ...
 *	for Param.
 */
public class CFBamCustEditorParamViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorParamViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsParam().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsParam().getOptionalLookupDefSchema() != null ) ) {
