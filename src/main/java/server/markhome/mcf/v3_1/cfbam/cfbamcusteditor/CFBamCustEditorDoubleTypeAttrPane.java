 ...
 *	for DoubleType.
 */
public class CFBamCustEditorDoubleTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXDoubleTypePaneCommon
{
	...
	public CFBamCustEditorDoubleTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
