 ...
 *	for RelationCol.
 */
public class CFBamCustEditorRelationColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorRelationColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsRelationCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsRelationCol().getOptionalLookupDefSchema() != null ) ) {
