 ...
 *	for SchemaRef.
 */
public class CFBamCustEditorSchemaRefViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorSchemaRefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( ( getJavaFXFocusAsSchemaRef() != null ) && getJavaFXFocusAsSchemaRef().getIsNew() ) {
