 ...
 *	for FloatType.
 */
public class CFBamCustEditorFloatTypeFactory
extends CFBamJavaFXFloatTypeFactory
{
	public CFBamCustEditorFloatTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamFloatTypeObj argFocus ) {
		CFBamCustEditorFloatTypeAttrPane retnew = new CFBamCustEditorFloatTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamFloatTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamFloatTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamFloatTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorFloatTypeViewEditForm retnew = new CFBamCustEditorFloatTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
