 ...
 *	for TimestampType.
 */
public class CFBamCustEditorTimestampTypeFactory
extends CFBamJavaFXTimestampTypeFactory
{
	public CFBamCustEditorTimestampTypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTimestampTypeObj argFocus ) {
		CFBamCustEditorTimestampTypeAttrPane retnew = new CFBamCustEditorTimestampTypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTimestampTypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamTimestampTypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTimestampTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTimestampTypeViewEditForm retnew = new CFBamCustEditorTimestampTypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
