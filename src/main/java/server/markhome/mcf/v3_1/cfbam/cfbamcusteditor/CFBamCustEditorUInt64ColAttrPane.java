 ...
 *	for UInt64Col.
 */
public class CFBamCustEditorUInt64ColAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt64ColPaneCommon
{
	...
	public CFBamCustEditorUInt64ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
