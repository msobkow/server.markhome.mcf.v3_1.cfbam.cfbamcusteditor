 ...
 *	for TextType.
 */
public class CFBamCustEditorTextTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXTextTypePaneCommon
{
	...
	public CFBamCustEditorTextTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		String initValue = getJavaFXEditorInitValue().getTextValue();
