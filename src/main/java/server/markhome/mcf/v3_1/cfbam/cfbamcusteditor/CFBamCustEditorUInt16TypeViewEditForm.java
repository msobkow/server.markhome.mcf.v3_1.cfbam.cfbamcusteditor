 ...
 *	for UInt16Type.
 */
public class CFBamCustEditorUInt16TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt16TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt16Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt16Type().getOptionalLookupDefSchema() != null ) ) {
