 ...
 *	for TZTimestampCol.
 */
public class CFBamCustEditorTZTimestampColAttrPane
extends CFGridPane
implements ICFBamJavaFXTZTimestampColPaneCommon
{
	...
	public CFBamCustEditorTZTimestampColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
