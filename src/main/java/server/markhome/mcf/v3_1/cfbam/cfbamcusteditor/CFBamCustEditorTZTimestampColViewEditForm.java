 ...
 *	for TZTimestampCol.
 */
public class CFBamCustEditorTZTimestampColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZTimestampColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZTimestampCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZTimestampCol().getOptionalLookupDefSchema() != null ) ) {
