 ...
 *	for TZDateType.
 */
public class CFBamCustEditorTZDateTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZDateTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZDateType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZDateType().getOptionalLookupDefSchema() != null ) ) {
