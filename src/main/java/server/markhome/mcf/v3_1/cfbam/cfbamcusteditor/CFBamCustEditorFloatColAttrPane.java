 ...
 *	for FloatCol.
 */
public class CFBamCustEditorFloatColAttrPane
extends CFGridPane
implements ICFBamJavaFXFloatColPaneCommon
{
	...
	public CFBamCustEditorFloatColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
