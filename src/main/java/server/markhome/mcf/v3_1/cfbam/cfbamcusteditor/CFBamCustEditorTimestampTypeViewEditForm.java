 ...
 *	for TimestampType.
 */
public class CFBamCustEditorTimestampTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTimestampTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTimestampType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTimestampType().getOptionalLookupDefSchema() != null ) ) {
