 ...
 *	for UuidType.
 */
public class CFBamCustEditorUuidTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUuidTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUuidType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUuidType().getOptionalLookupDefSchema() != null ) ) {
