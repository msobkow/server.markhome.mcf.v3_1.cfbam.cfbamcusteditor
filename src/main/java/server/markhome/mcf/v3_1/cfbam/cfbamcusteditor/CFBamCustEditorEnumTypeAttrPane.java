 ...
 *	for EnumType.
 */
public class CFBamCustEditorEnumTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXEnumTypePaneCommon
{
	...
	public CFBamCustEditorEnumTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
