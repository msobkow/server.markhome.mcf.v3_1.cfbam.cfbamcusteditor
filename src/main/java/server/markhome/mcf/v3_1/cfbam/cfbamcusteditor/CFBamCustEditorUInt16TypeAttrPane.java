 ...
 *	for UInt16Type.
 */
public class CFBamCustEditorUInt16TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt16TypePaneCommon
{
	...
	public CFBamCustEditorUInt16TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
