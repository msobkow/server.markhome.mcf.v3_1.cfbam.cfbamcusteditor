 ...
 *	for Value.
 */
public class CFBamCustEditorValueFactory
extends CFBamJavaFXValueFactory
{
	public CFBamCustEditorValueFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorValueListPane retnew = new CFBamCustEditorValueListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
