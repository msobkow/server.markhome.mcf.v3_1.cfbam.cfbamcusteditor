 ...
 *	for TimestampCol.
 */
public class CFBamCustEditorTimestampColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTimestampColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTimestampCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTimestampCol().getOptionalLookupDefSchema() != null ) ) {
