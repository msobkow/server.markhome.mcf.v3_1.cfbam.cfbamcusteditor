 ...
 *	for UuidCol.
 */
public class CFBamCustEditorUuidColFactory
extends CFBamJavaFXUuidColFactory
{
	public CFBamCustEditorUuidColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamUuidColObj argFocus ) {
		CFBamCustEditorUuidColAttrPane retnew = new CFBamCustEditorUuidColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamUuidColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamUuidColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamUuidColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorUuidColViewEditForm retnew = new CFBamCustEditorUuidColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
