 ...
 *	for Table.
 */
public class CFBamCustEditorTableViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTableViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTable().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( buttonEdit != null ) {
				if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTable().getOptionalLookupDefSchema() != null ) ) {
