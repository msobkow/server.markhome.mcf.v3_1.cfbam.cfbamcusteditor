 ...
 *	for UuidType.
 */
public class CFBamCustEditorUuidTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUuidTypePaneCommon
{
	...
	public CFBamCustEditorUuidTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
