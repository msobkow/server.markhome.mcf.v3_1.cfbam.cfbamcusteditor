 ...
 *	for TimeCol.
 */
public class CFBamCustEditorTimeColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTimeColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTimeCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTimeCol().getOptionalLookupDefSchema() != null ) ) {
