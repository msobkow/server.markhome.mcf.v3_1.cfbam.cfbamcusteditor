 ...
 *	for FloatType.
 */
public class CFBamCustEditorFloatTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXFloatTypePaneCommon
{
	...
	public CFBamCustEditorFloatTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
