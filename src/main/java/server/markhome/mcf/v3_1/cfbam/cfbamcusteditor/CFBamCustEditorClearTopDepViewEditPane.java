 ...
 *	for ClearTopDep.
 */
public class CFBamCustEditorClearTopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXClearTopDepPaneCommon
{
	...
	public CFBamCustEditorClearTopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus ) {
		super();
