 ...
 *	for Int32Type.
 */
public class CFBamCustEditorInt32TypeFactory
extends CFBamJavaFXInt32TypeFactory
{
	public CFBamCustEditorInt32TypeFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamInt32TypeObj argFocus ) {
		CFBamCustEditorInt32TypeAttrPane retnew = new CFBamCustEditorInt32TypeAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamInt32TypeObj argFocus,
		ICFBamSchemaDefObj argContainer,
		Collection<ICFBamInt32TypeObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamInt32TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorInt32TypeViewEditForm retnew = new CFBamCustEditorInt32TypeViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
