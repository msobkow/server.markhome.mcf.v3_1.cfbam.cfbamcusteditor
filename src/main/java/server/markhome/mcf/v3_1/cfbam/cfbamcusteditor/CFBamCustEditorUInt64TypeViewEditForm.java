 ...
 *	for UInt64Type.
 */
public class CFBamCustEditorUInt64TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt64TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt64Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt64Type().getOptionalLookupDefSchema() != null ) ) {
