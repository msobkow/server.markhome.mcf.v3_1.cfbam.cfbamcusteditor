 ...
 *	for DelTopDep.
 */
public class CFBamCustEditorDelTopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDelTopDepPaneCommon
{
	...
	public CFBamCustEditorDelTopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus ) {
		super();
