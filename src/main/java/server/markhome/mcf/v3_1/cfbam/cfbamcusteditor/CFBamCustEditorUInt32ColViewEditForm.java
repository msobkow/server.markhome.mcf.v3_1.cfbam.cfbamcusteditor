 ...
 *	for UInt32Col.
 */
public class CFBamCustEditorUInt32ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt32ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt32Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt32Col().getOptionalLookupDefSchema() != null ) ) {
