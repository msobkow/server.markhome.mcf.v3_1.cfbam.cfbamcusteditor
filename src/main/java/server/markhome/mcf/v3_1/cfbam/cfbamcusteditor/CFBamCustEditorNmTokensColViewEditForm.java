 ...
 *	for NmTokensCol.
 */
public class CFBamCustEditorNmTokensColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNmTokensColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNmTokensCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNmTokensCol().getOptionalLookupDefSchema() != null ) ) {
