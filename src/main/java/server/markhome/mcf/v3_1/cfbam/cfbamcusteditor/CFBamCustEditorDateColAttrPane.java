 ...
 *	for DateCol.
 */
public class CFBamCustEditorDateColAttrPane
extends CFGridPane
implements ICFBamJavaFXDateColPaneCommon
{
	...
	public CFBamCustEditorDateColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
