 ...
 *	for ServerObjFunc.
 */
public class CFBamCustEditorServerObjFuncViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorServerObjFuncViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerObjFuncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsServerObjFunc().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsServerObjFunc().getOptionalLookupDefSchema() != null ) ) {
