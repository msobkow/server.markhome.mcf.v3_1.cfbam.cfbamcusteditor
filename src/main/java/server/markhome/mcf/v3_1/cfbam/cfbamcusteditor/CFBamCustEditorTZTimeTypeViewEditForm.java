 ...
 *	for TZTimeType.
 */
public class CFBamCustEditorTZTimeTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorTZTimeTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsTZTimeType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsTZTimeType().getOptionalLookupDefSchema() != null ) ) {
