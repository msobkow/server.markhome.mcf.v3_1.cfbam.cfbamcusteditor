 ...
 *	for IndexCol.
 */
public class CFBamCustEditorIndexColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorIndexColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsIndexCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsIndexCol().getOptionalLookupDefSchema() != null ) ) {
