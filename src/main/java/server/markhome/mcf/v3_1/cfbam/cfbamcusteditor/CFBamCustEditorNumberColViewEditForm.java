 ...
 *	for NumberCol.
 */
public class CFBamCustEditorNumberColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNumberColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNumberCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNumberCol().getOptionalLookupDefSchema() != null ) ) {
