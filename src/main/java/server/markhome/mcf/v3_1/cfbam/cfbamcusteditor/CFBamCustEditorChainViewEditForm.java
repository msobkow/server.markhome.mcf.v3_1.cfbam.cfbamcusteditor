 ...
 *	for Chain.
 */
public class CFBamCustEditorChainViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorChainViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsChain().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsChain().getOptionalLookupDefSchema() != null ) ) {
