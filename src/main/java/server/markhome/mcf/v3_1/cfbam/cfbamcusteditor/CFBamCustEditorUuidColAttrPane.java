 ...
 *	for UuidCol.
 */
public class CFBamCustEditorUuidColAttrPane
extends CFGridPane
implements ICFBamJavaFXUuidColPaneCommon
{
	...
	public CFBamCustEditorUuidColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
