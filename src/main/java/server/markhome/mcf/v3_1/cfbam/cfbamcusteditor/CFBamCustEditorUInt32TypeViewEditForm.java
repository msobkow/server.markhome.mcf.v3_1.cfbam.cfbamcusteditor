 ...
 *	for UInt32Type.
 */
public class CFBamCustEditorUInt32TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt32TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt32Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt32Type().getOptionalLookupDefSchema() != null ) ) {
