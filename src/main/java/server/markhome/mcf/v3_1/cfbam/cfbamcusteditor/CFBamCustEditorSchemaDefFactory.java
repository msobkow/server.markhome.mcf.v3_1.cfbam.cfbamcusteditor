 ...
 *	for SchemaDef.
 */
public class CFBamCustEditorSchemaDefFactory
extends CFBamJavaFXSchemaDefFactory
{
	public CFBamCustEditorSchemaDefFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamSchemaDefObj argFocus ) {
		CFBamCustEditorSchemaDefAttrPane retnew = new CFBamCustEditorSchemaDefAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFTabPane newEltTabPane( ICFFormManager formManager, ICFBamSchemaDefObj argFocus ) {
		CFBamCustEditorSchemaDefEltTabPane retnew = new CFBamCustEditorSchemaDefEltTabPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamSchemaDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorSchemaDefViewEditForm retnew = new CFBamCustEditorSchemaDefViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
