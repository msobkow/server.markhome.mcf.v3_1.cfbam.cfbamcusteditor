 ...
 *	for NumberType.
 */
public class CFBamCustEditorNumberTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXNumberTypePaneCommon
{
	...
	public CFBamCustEditorNumberTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
