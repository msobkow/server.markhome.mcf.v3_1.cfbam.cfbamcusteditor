 ...
 *	for Id32Gen.
 */
public class CFBamCustEditorId32GenFactory
extends CFBamJavaFXId32GenFactory
{
	public CFBamCustEditorId32GenFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamId32GenObj argFocus ) {
		CFBamCustEditorId32GenAttrPane retnew = new CFBamCustEditorId32GenAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamId32GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorId32GenViewEditForm retnew = new CFBamCustEditorId32GenViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
