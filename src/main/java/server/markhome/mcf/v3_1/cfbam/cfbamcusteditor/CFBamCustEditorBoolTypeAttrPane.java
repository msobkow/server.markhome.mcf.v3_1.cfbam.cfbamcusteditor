 ...
 *	for BoolType.
 */
public class CFBamCustEditorBoolTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXBoolTypePaneCommon
{
	...
	public CFBamCustEditorBoolTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
