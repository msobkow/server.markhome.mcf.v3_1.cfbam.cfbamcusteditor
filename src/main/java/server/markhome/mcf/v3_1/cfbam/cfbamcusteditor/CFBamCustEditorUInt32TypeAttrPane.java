 ...
 *	for UInt32Type.
 */
public class CFBamCustEditorUInt32TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt32TypePaneCommon
{
	...
	public CFBamCustEditorUInt32TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
