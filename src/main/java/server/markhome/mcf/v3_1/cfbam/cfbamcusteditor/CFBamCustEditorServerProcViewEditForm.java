 ...
 *	for ServerProc.
 */
public class CFBamCustEditorServerProcViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorServerProcViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsServerProc().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsServerProc().getOptionalLookupDefSchema() != null ) ) {
