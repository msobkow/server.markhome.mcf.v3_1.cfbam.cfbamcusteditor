 ...
 *	for UuidGen.
 */
public class CFBamCustEditorUuidGenAttrPane
extends CFGridPane
implements ICFBamJavaFXUuidGenPaneCommon
{
	...
	public CFBamCustEditorUuidGenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
