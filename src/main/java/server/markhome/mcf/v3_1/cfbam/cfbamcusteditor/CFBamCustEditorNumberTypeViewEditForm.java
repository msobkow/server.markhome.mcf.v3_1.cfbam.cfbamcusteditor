 ...
 *	for NumberType.
 */
public class CFBamCustEditorNumberTypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorNumberTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsNumberType().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsNumberType().getOptionalLookupDefSchema() != null ) ) {
