 ...
 *	for Index.
 */
public class CFBamCustEditorIndexAttrPane
extends CFGridPane
implements ICFBamJavaFXIndexPaneCommon
{
	...
	public CFBamCustEditorIndexAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
