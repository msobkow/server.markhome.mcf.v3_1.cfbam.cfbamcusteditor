 ...
 *	for Index.
 */
public class CFBamCustEditorIndexViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorIndexViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsIndex().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsIndex().getOptionalLookupDefSchema() != null ) ) {
