 ...
 *	for EnumTag.
 */
public class CFBamCustEditorEnumTagFactory
extends CFBamJavaFXEnumTagFactory
{
	public CFBamCustEditorEnumTagFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamEnumTagObj argFocus ) {
		CFBamCustEditorEnumTagAttrPane retnew = new CFBamCustEditorEnumTagAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorEnumTagListPane retnew = new CFBamCustEditorEnumTagListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamEnumTagObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorEnumTagViewEditForm retnew = new CFBamCustEditorEnumTagViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
