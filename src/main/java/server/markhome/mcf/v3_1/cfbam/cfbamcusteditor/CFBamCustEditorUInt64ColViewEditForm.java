 ...
 *	for UInt64Col.
 */
public class CFBamCustEditorUInt64ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUInt64ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUInt64Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUInt64Col().getOptionalLookupDefSchema() != null ) ) {
