 ...
 *	for Id16Gen.
 */
public class CFBamCustEditorId16GenAttrPane
extends CFGridPane
implements ICFBamJavaFXId16GenPaneCommon
{
	...
	protected ICFBamId16GenObj getEffJavaFocus() {
		ICFBamId16GenObj obj = (ICFBamId16GenObj)getJavaFXFocusAsId16Gen().getEdit();
		if( obj == null ) {
			obj = getJavaFXFocusAsId16Gen();
		}
		return( obj );
	}
	...
	public CFBamCustEditorId16GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void setJavaFXReferenceLookupDispenser( DispenserCFEditor value ) {
