 ...
 *	for IndexCol.
 */
public class CFBamCustEditorIndexColAttrPane
extends CFGridPane
implements ICFBamJavaFXIndexColPaneCommon
{
	...
	public CFBamCustEditorIndexColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
