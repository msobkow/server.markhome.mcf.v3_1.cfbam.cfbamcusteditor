 ...
 *	for TimestampCol.
 */
public class CFBamCustEditorTimestampColAttrPane
extends CFGridPane
implements ICFBamJavaFXTimestampColPaneCommon
{
	...
	public CFBamCustEditorTimestampColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
