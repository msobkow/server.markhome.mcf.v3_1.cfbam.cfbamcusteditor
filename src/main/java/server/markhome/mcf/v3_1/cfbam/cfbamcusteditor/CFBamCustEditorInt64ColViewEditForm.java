 ...
 *	for Int64Col.
 */
public class CFBamCustEditorInt64ColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt64ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt64Col().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt64Col().getOptionalLookupDefSchema() != null ) ) {
