 ...
 *	for Chain.
 */
public class CFBamCustEditorChainAttrPane
extends CFGridPane
implements ICFBamJavaFXChainPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			Collection<ICFBamRelationObj> cltn = editObj.getRequiredContainerTable().getOptionalComponentsRelation();
	...
	public CFBamCustEditorChainAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public void postFields()
	{
		...
		if( editObj.getRequiredLookupPrevRel() == null ) {
			throw new CFLibNullArgumentException( getClass(),
				S_ProcName,
				0,
				"Prev Relation" );
		...
		if( editObj.getRequiredLookupNextRel() == null ) {
			throw new CFLibNullArgumentException( getClass(),
				S_ProcName,
				0,
				"Next Relation" );
