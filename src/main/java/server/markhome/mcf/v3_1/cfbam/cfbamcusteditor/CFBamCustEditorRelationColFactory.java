 ...
 *	for RelationCol.
 */
public class CFBamCustEditorRelationColFactory
extends CFBamJavaFXRelationColFactory
{
	public CFBamCustEditorRelationColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamRelationColObj argFocus ) {
		CFBamCustEditorRelationColAttrPane retnew = new CFBamCustEditorRelationColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newListPane( ICFFormManager formManager,
		...
		boolean sortByChain )
	{
		CFBamCustEditorRelationColListPane retnew = new CFBamCustEditorRelationColListPane( formManager,
			javafxSchema,
			argContainer,
			argFocus,
			argDataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamRelationColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorRelationColViewEditForm retnew = new CFBamCustEditorRelationColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
