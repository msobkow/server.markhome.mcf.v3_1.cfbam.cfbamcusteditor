 ...
 *	for DateType.
 */
public class CFBamCustEditorDateTypeAttrPane
extends CFGridPane
implements ICFBamJavaFXDateTypePaneCommon
{
	...
	public CFBamCustEditorDateTypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
