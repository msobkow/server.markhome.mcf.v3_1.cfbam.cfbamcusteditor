 ...
 *	for TimeCol.
 */
public class CFBamCustEditorTimeColAttrPane
extends CFGridPane
implements ICFBamJavaFXTimeColPaneCommon
{
	...
	public CFBamCustEditorTimeColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
