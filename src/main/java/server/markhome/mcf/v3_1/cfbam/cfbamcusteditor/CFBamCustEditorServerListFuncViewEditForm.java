 ...
 *	for ServerListFunc.
 */
public class CFBamCustEditorServerListFuncViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorServerListFuncViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsServerListFunc().getOptionalLookupDefSchema() == null ) {
