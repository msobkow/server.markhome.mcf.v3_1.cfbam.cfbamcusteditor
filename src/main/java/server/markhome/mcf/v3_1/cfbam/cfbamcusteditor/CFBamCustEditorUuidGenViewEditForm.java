 ...
 *	for UuidGen.
 */
public class CFBamCustEditorUuidGenViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorUuidGenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsUuidGen().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsUuidGen().getOptionalLookupDefSchema() != null ) ) {
