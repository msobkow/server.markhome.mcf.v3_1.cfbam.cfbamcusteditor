 ...
 *	for TZDateCol.
 */
public class CFBamCustEditorTZDateColAttrPane
extends CFGridPane
implements ICFBamJavaFXTZDateColPaneCommon
{
	...
	public CFBamCustEditorTZDateColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
