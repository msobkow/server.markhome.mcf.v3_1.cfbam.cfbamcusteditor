 ...
 *	for SchemaDef.
 */
public class CFBamCustEditorSchemaDefViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorSchemaDefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
			...
			buttonValidateModel.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						ICFBamSchemaDefObj schemaDef = getJavaFXFocusAsSchemaDef();
