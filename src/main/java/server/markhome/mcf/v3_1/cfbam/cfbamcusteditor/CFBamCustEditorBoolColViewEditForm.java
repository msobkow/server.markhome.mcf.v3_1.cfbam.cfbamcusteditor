 ...
 *	for BoolCol.
 */
public class CFBamCustEditorBoolColViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorBoolColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsBoolCol().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsBoolCol().getOptionalLookupDefSchema() != null ) ) {
