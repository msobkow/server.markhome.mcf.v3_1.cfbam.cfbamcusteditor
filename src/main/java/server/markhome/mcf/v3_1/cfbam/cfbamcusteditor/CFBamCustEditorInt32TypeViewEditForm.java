 ...
 *	for Int32Type.
 */
public class CFBamCustEditorInt32TypeViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorInt32TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsInt32Type().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsInt32Type().getOptionalLookupDefSchema() != null ) ) {
