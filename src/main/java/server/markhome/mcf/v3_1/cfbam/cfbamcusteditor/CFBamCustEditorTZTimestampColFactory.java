 ...
 *	for TZTimestampCol.
 */
public class CFBamCustEditorTZTimestampColFactory
extends CFBamJavaFXTZTimestampColFactory
{
	public CFBamCustEditorTZTimestampColFactory( ICFBamJavaFXSchema argSchema ) {
		super( argSchema );
	}

	public CFGridPane newAttrPane( ICFFormManager formManager, ICFBamTZTimestampColObj argFocus ) {
		CFBamCustEditorTZTimestampColAttrPane retnew = new CFBamCustEditorTZTimestampColAttrPane( formManager, javafxSchema, argFocus );
		return( retnew );
	}
	...
	public CFBorderPane newPickerPane( ICFFormManager formManager,
		ICFBamTZTimestampColObj argFocus,
		ICFBamTableObj argContainer,
		Collection<ICFBamTZTimestampColObj> dataCollection,
	...
	public CFBorderPane newViewEditForm( ICFFormManager formManager, ICFBamTZTimestampColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		CFBamCustEditorTZTimestampColViewEditForm retnew = new CFBamCustEditorTZTimestampColViewEditForm( formManager, javafxSchema, argFocus, closeCallback, cameFromAdd );
		return( retnew );
	}
}
