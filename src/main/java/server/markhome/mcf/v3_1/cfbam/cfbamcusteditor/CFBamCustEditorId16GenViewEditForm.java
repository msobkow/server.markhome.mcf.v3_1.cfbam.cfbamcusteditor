 ...
 *	for Id16Gen.
 */
public class CFBamCustEditorId16GenViewEditForm
	...
	ICFForm
{
	...
	public CFBamCustEditorId16GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public CFHBox getHBoxMenu() {
		if( hboxMenu == null ) {
			...
			if( getJavaFXFocusAsId16Gen().getOptionalLookupDefSchema() == null ) {
	...
	public void adjustButtons() {
		...
		if( value == CFPane.PaneMode.View ) {
			if( ( javaFXFocus == null ) || ( getJavaFXFocusAsId16Gen().getOptionalLookupDefSchema() != null ) ) {
